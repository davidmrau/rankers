...
echo "BM25"
REF=../runs/2020_top_100.scores_all.trec
python3 significance_ranks.py $REF $1 $2

echo "big bird"
REF=../checkpoints/2019_docs_bigbertbz_16_lr_3e-06_docs_train_lr_3e-6/model_eval_ranking9.trec.scores_all_topics.trec
python3 significance_ranks.py $REF $1 $2


echo "longformer"
REF=../checkpoints/2019_docs_longformerbz_16_lr_3e-06_docs_train_lr_3e-6/model_eval_ranking5.trec.scores_all_topics.trec
python3 significance_ranks.py $REF $1 $2


echo "longformer-qa"
REF=../checkpoints/2019_docs_longformer-qabz_16_lr_3e-06_docs_train_lr_3e-6_title+body/model_eval_ranking5.trec.scores_all_topics.trec
python3 significance_ranks.py $REF $1 $2
